...
public class DateUtils {
    ...
    public static Date parse(String dateString, SimpleDateFormat simpleDateFormat) {
        try {
            ...
            throw new CustomException("Parse [" + simpleDateFormat.toPattern() + "] with format [" + dateString + "] error!");
        }
    }
    ...
    public static Date parse(String dateString) {
        ...
        try {
            ...
            throw new CustomException("Parse [" + dateStr + "] with format normal error!", e);
        }

        // 没有更多匹配的时间格式
        throw new CustomException("[" + dateStr + "] format is not fit for date pattern!");
    }
